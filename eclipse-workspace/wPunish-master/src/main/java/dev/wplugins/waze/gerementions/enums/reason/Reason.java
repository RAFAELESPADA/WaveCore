...
public enum Reason {
    ...
    ANTIJOGO("Anti jogo (Jogo)", PunishType.valueOf(Main.getInstance().getConfig().getString("PunicaoAntiJogo")),  TimeUnit.valueOf(Main.getInstance().getConfig().getString("AntiJogoTempoType")).toMillis(Main.getInstance().getConfig().getInt("AntiJogo-Game-TempoBan"))),
    ...
    VIOLACAO_DAS_DIRETRIZES("Violação das Diretrizes", PunishType.valueOf(Main.getInstance().getConfig().getString("PunicaoViolacaoDiretrizes")), TimeUnit.valueOf(Main.getInstance().getConfig().getString("ViolacaoDasDiretrizesTempoType")).toMillis(Main.getInstance().getConfig().getInt("ViolacaoDasDiretrizesTempoBan"))),
    ...
    OFENSA_A_JOGADOR("Ofensa a jogador", PunishType.valueOf(Main.getInstance().getConfig().getString("PunicaoOfensaAPlayer")), TimeUnit.valueOf(Main.getInstance().getConfig().getString("OfensaAPlayerTempoType")).toMillis(Main.getInstance().getConfig().getInt("OfensaaPlayerTempoMute"))),
    OFENSA_A_STAFF("Ofensa a staff/servidor", PunishType.valueOf(Main.getInstance().getConfig().getString("PunicaoOfensaAStaff")), TimeUnit.valueOf(Main.getInstance().getConfig().getString("OfensaAStaffTempoType")).toMillis(Main.getInstance().getConfig().getInt("OfensaaStaffTempoMute"))),
